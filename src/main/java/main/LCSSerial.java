...
/**
 * Class used to solve a given dynamic problem (LCS in this current version) iteratively.
 * @author fede3751
 *
 */
public class LCSSerial
{
	...
	/**
	 * GetMethod, only top and left corners have the correct value if solve() is not called first
	...
	{
		//Current state: just apply the LCS problem rule
